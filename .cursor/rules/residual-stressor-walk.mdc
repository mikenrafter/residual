...
name: stressor-walk
passthrough: true
description: Residual stressor-walk — begin with residual skill show / skill data
---

The operator has requested you (agent) walk the stressors in this project. Begin by running `residual skill show stressor-walk` and `residual skill data stressor-walk`.
