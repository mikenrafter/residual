...
name: atam
passthrough: true
description: Residual atam — begin with residual skill-show / skill-data
---

The operator has requested you (agent) run ATAM in this project. Begin by running `residual skill-show atam` and `residual skill-data atam`.
