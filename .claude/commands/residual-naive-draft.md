...
name: naive-draft
passthrough: true
description: Residual naive-draft — begin with residual skill-show / skill-data
---

The operator has requested you (agent) draft a naïve architecture in this project. Begin by running `residual skill-show naive-draft` and `residual skill-data naive-draft`.
