...
name: fmea
passthrough: true
description: Residual fmea — begin with residual skill show / skill data
---

The operator has requested you (agent) run FMEA in this project. Begin by running `residual skill show fmea` and `residual skill data fmea`.
